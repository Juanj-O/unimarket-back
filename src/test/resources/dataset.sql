...
INSERT INTO unimarket.usuario VALUES ("4444","$2a$10$.izhxeGtupPsWWqWt7Lnz..4au/ip7W2r.r3pGQJF4KYBeErPlH1u","carrera 14","pedrorodriguez@hotmail.com",1,"juan lopez","3218745560",1);
...
INSERT INTO unimarket.producto VALUES (1,"AUDIFONOS SAMSUNG 158-6685",1,now(),date_add(now(),interval 60 DAY),"AUDIFONOS SAMSUNG",75000,10,4444);
INSERT INTO unimarket.producto VALUES (2,"MacBook (Retina, 12 pulgadas, 2017)",1,now(),date_add(now(),interval 60 DAY),"MacBook10,1",6000000,1,4444);
...
INSERT INTO unimarket.producto VALUES (4,"TV LG 75 Pulgadas 189 cm, MODELO:75NANO75SQA, INCLUYE: CABLE DE PODER, BASE, MAGIC REMOTE, MANUAL DE USUARIO ",1,now(),date_add(now(),interval 60 DAY),"TV LG 75 Pulgadas 189 cm 75NANO75SQA 4K-UHD NanoCell Smart TV",3949900,15,5678);
...
INSERT INTO unimarket.comentario VALUES (1,"EXCELENTE PRODUCTO",now(),1,4444);
INSERT INTO unimarket.comentario VALUES (2,"EXCELENTE PRODUCTO",now(),2,4444);
...
INSERT INTO unimarket.comentario VALUES (6,"EXCELENTE PRODUCTO",now(),1,4444);

INSERT INTO unimarket.compra VALUES (1,now(),1,150000,1478);
INSERT INTO unimarket.compra VALUES (2,now(),2,6000000,1478);
...
INSERT INTO unimarket.favorito VALUES ("4444",2);
INSERT INTO unimarket.favorito VALUES ("5678",3);
INSERT INTO unimarket.favorito VALUES ("1478",5);
INSERT INTO unimarket.favorito VALUES ("1478",6);

INSERT INTO unimarket.moderador VALUES (1,"$2a$10$QR4nBbO0ZdyQE6VaX5hAc.ewtbR7EuBB1CmoM8EidAPzof.FlA1p.","juan@juan.com","esteban uran");
...
INSERT INTO unimarket.moderador VALUES (6,"$10$7FQBAfON5Iu2INcnyPO6W.1eqI44ixaQ4rucVMLFCfJPTzx.aW8Mu","correo@correo.com","9999");
...
INSERT INTO unimarket.pqrs VALUES (1,now(),"QUEJA 1",1,"1478");
INSERT INTO unimarket.pqrs VALUES (2,now(),"QUEJA 1",3,"5678");
INSERT INTO unimarket.pqrs VALUES (3,now(),"QUEJA 2",1,"1478");
